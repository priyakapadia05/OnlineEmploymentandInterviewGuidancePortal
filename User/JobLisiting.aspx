 <%@ Page Title="" Language="C#" MasterPageFile="~/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="JobLisiting.aspx.cs" Inherits="OnlineJobPortal.User.JobLisiting" %>
                        ...
                        <div class="job-category-listing mb-50 pb-0">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-job-items2">
                                    ...
                                    <asp:DropDownList ID="ddlCountry" runat="server" AutoPostBack="true" CssClass="form-control w-100" OnSelectedIndexChanged="ddlCountry_SelectedIndexChanged" AppendDataBoundItems="true" DataTextField="C_name" DataValueField="Cou_id">
                                ...
                                <div class="select-Categories pt-80 pb-50">
                                    ...
                                    <div class="checkbox checkbox-primary">
                                        ...
                                        <asp:CheckBoxList ID="cblType" runat="server" AutoPostBack="True"

                                            RepeatDirection="Vertical" RepeatLayout="Flow" CssClass="styled"

                                            TextAlign="Right" OnSelectedIndexChanged="cblType_SelectedIndexChanged">
                            ...
                            <div class="single-listing">
                                ...
                                <div class="select-Categories pb-50">
                                    ...
                                    <div class="radiobuttoncontainer">
                                        ...
                                        <asp:RadioButtonList ID="rblPostedDay" runat="server" CssClass="radiobuttonlist" AutoPostBack="true"

                                            OnSelectedIndexChanged="rblPostedDay_SelectedIndexChanged" RepeatLayout="Flow">
                    ...
                    <div class="col-xl-10 col-lg-9 col-md-8">
                        ...
                        <section class="featured-job-area">
                            ...
                            <div class="container">
                                ...
                                <asp:DataList ID="dlJobList" runat="server">
