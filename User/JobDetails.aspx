...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="job-post-company pt-120 pb-120">
            <div class="container">
                <asp:DataList ID="dlJobDetails" runat="server" OnItemCommand="dlJobDetails_ItemCommand" OnItemDataBound="dlJobDetails_ItemDataBound">
                            ...
                            <div class="col-xl-4 col-lg-4">
                                <div class="post-details3  mb-50">
                                    ...
                                    <ul>
                                        ...
                                        <li>Last date : <span><%# DataBinder.Eval(Container.DataItem, "LastDateToAplly", "{0:dd MMMM yyyy}") %></span></li>
                                    </ul>
                                    <div class="apply-btn2">
                                        <asp:LinkButton ID="lbApplyJob" runat="server" Text="Apply Now" CssClass="btn" CommandName="ApplyJob" ></asp:LinkButton>
                                    </div>
                                </div>
                                <div class="post-details4  mb-50">
                                    ...
                                    <p>Leading IT company offering innovative solutions in software development, cybersecurity, cloud computing, and digital transformation services.</p>
                                    <ul>
                                        <li>Address : <span><%# Eval("Address") %> </span></li>
