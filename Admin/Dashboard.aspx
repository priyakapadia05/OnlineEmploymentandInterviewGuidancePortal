                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card l-bg-cherry">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row-align-item-center mb-2 d-flex">
                                    <div class="col-8">
                        ...
                        <div class="card l-bg-blue-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row-align-item-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <%Response.Write(Session["Job"]); %> <%--User Count--%>
                                        </h2>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-6">
                        <div class="card l-bg-cyan">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="mb-4">
                                    <h5 class="card-title mb-0">Total Guides</h5>
                                </div>
                                <div class="row-align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0"><%Response.Write(Session["Guide"]); %> </h2>
                                        <%--Guide count--%>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row-align-item-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            <%Response.Write(Session["AppliedJob"]); %> <%--User Count--%>
                                        </h2>
                                    </div>
                                </div>
                            </div>
