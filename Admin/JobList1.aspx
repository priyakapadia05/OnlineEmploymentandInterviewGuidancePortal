<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="JobList1.aspx.cs" Inherits="OnlineJobPortal.Admin.JobList1" %>
    ...
    <div style="background-image: url('../Images/bg.jpg'); width: 100%; height: 720px; background-repeat: no-repeat; background-size: cover; background-attachment: fixed">
        <div class="container-fluid pt-4 pb-4">
            ...
            <div class="row mb-3 pt-sm-3">
                <div class="col-md-12">
                    <asp:GridView ID="dtgJobList" runat="server" CssClass="table table-hover table-bordered"
                        EmptyDataText="No record to display..!" AutoGenerateColumns="False" AllowPaging="True" PageSize="5"
                        OnPageIndexChanging="dtgJobList_PageIndexChanging" DataKeyNames="Job_id" OnRowDeleting="dtgJobList_RowDeleting" OnRowCommand="dtgJobList_RowCommand" OnRowDataBound="dtgJobList_RowDataBound">
                        <Columns>
                            ...
                            <asp:BoundField DataField="LastDateToAplly" HeaderText="Valid Till" DataFormatString="{0:dd MMMM yyyy}">
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEditJob" runat="server" CommandName="EditJob" CommandArgument='<%# Eval("Job_id") %>'>
